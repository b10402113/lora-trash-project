...
def post_trash_data(request):
    if request.method == 'POST':
        ...
        try:
            if (int(weight) > 2000 or int(height) > 20) and trash_can.send_email_bit is False:
                ...
                if int(weight) > 2000:
                    ...
                    msg = (MIMEText('<h1>垃圾過量警告！</h1><p>地點：'+str(trash_can.tloaction_name)+'</p>高度已經過高，請盡快去收垃圾！</p>','html','utf-8'))
